...
public class RoundTrip extends BaseSJ {
...
public RoundTrip clickroundtrip1() throws InterruptedException {
	Thread.sleep(2000);
...
public RoundTrip Selectdepature() throws InterruptedException {
	//click(nextbtn); 
...
public RoundTrip Selectreturn() throws InterruptedException {
	//click(nextbtn); 
	WebElement date=driver.findElement(By.xpath("//div[text()='31'][1]"));
	  date.click();
	return this;
}
	...
	public RoundTrip clickroundtrip111() throws InterruptedException {
	Thread.sleep(3000);
...
public RoundTrip clickroundtrip2() throws InterruptedException {
	Thread.sleep(3000);
	click(continuebtn1);
	...
	public RoundTrip clickroundtrip3(String firstname,String lastname,String mobile) {
	click(passenger2);
	type(p2fn, firstname);
	type(p2ln, lastname);
	...
	public RoundTrip clickroundtrip4() throws InterruptedException {
		click(continuebtn2);
		Thread.sleep(3000);
//		click(application);
//		click(application);
	...
	public RoundTrip clickroundtrip5(String cardno) throws InterruptedException {
